...
const singularityProfiles = {
  ...
  'TNG-006': {
    ...
    desc: "A large, humanoid-shaped marine organism documented almost exclusively in Antarctic waters, first entering public awareness through a wave of amateur photographs and video circulated on Japanese internet forums in the early 2000s and subsequently dismissed by mainstream skeptics as misidentified whales, icebergs, or deliberate hoaxes — a conclusion I.R.I.S. internal analysis does not dispute in public-facing correspondence. <span class=\"redact-block\">Internal assessment confirms TNG-006 as a genuine biological entity independent of the public hoax narrative. Confirmed specimens present a pale, featureless humanoid silhouette lacking clearly differentiated facial structures, with limb-like appendages of inconsistent number and placement across sightings — no two confirmed encounters have described an identical body plan, and internal biology staff remain divided on whether this reflects genuine morphological variability, a highly plastic body structure, or simple observational unreliability under difficult recovery conditions.</span> TNG-006 has been confirmed, via recovered stomach contents and direct observation, to feed primarily on TVP-005 juveniles, placing it in direct dietary overlap and apparent competition with TPI-003 colonies operating in the same nesting areas. <span class=\"redact-block\">TNG-006 is not understood to be an apex predator in its own habitat. It is, in turn, confirmed prey for TBL-007 (cross-reference below), which has been documented pursuing and consuming TNG-006 individuals on at least three occasions captured by remote survey equipment.</span> No living specimen has ever been recovered for direct study; all physical evidence to date consists of partial remains and long-range visual or photographic documentation."
  },
  'TBL-007': {
    id: 'TBL-007',
    isNew: true,
    ...
    desc: "A confirmed biological organism responsible for a widely-publicized 1997 ultra-low-frequency acoustic signal, detected by hydrophone arrays across a wide area of the Pacific and publicly nicknamed 'the Bloop.' The signal was later attributed by public researchers to an icequake event in Antarctica — a conclusion I.R.I.S. internal analysis does not dispute in public-facing correspondence. <span class=\"redact-block\">The icequake explanation is incorrect. TBL-007 is a confirmed member of the cetacean lineage, presenting as a massive mutation of unknown trigger far exceeding the size of any known whale species, including the blue whale. Comparative tissue analysis shows clear structural homology with known baleen whale families, ruling out the alternate hypothesis that TBL-007 represents an entirely separate, unrelated organism. The mutation's cause — environmental, biological, or otherwise — has not been established, and I.R.I.S. has not ruled out a connection to broader Region-3 anomalous activity given the organism's confirmed range overlap with TVP-005 and TNG-006 territory.</span> TBL-007 has been documented, via remote survey footage on at least three occasions, actively pursuing and consuming TNG-006 individuals, placing it at the apex of a locally confirmed predatory chain: TBL-007 preys on TNG-006, which in turn preys on TVP-005 juveniles. <span class=\"redact-block\">Confirmed population estimates place TBL-007 numbers unusually low relative to its position in the food web, a discrepancy internal ecology staff have been unable to explain through predation by TNG-006 alone, given the size disparity between the two. This scarcity is treated as indirect — though unconfirmed — evidence that TVP-005 itself preys on TBL-007. No physical remains supporting this theory have ever been recovered; I.R.I.S. attributes this to the Leviathan's method of consumption and scale rather than to the theory's inaccuracy, a distinction that has done little to move the theory out of speculative status after repeated internal review.</span> <span class=\"redact-block\">TBL-007 is confirmed to periodically discharge a dense, black, acidic secretion through its gill structures, internally designated the Black Tide. The discharge is understood to be an involuntary defensive or physiological response rather than a deployed or directed attack, functionally comparable to cephalopod ink release, though occurring at a scale consistent with the organism's size. The secretion is toxic to surrounding marine life and measurably corrosive to organic and some inorganic material on contact; affected water remains uninhabitable for an extended, undetermined period following a discharge event. Personnel are advised that Black Tide contamination has been logged in proximity to multiple Null Zone sites, raising unconfirmed concern regarding cumulative ecological impact on TVP-005 nesting territory.</span> The 1997 signal remains the only confirmed acoustic detection event attributed to TBL-007 to date."
  },
  'TPC-008': {
    id: 'TPC-008',
