...
const singularityProfiles = {
  ...
  'TTR-001': {
    ...
    height: "N/A (geological formation)",
  ...
  'TPM-002': {
    id: 'TPM-002',
    isNew: true,
    name: 'The Maritime Pangaea',
    types: ['type-geo', 'GEOLOGICAL'],
    origin: 'TVP-005 (confirmed trigger event)',
    region: 'Non-localized — global oceanic event',
    status: 'DEAD — HISTORICAL EVENT',
    statusColor: '#c84a4a',
    image: null,
    height: "N/A (historical event, not a discrete entity)",
    desc: "Internal designation for a confirmed prehistoric large-scale oceanic disturbance, understood to be the direct result of a single awakening event attributed to TVP-005. The event is classified as Geological rather than Biological or Paranormal, as its documented effects — sudden, sustained reordering of global ocean currents and sea levels sufficient to physically displace a landmass — are consistent with catastrophic geological upheaval rather than any discrete biological action. Sediment core samples taken from multiple, geographically unrelated ocean-floor sites show a simultaneous disruption layer consistent with a single global event rather than a series of regional ones — an unusual finding for a disturbance of this scale, and one of the primary reasons the Maritime Pangaea is treated as a single unified incident rather than a loosely-connected series of prehistoric floods, as earlier internal theories proposed before the TVP-005 connection was established. The Maritime Pangaea is confirmed to have physically divided a then-inhabited landmass. The first fragment was driven adrift and is believed to survive, unlocated, somewhere in the world's oceans; no confirmed sighting, wreckage, or landmass matching its expected profile has ever been logged by I.R.I.S. or any partner agency, though isolated, uncorroborated mariner reports of 'land where no land should be' recur throughout recorded maritime history with enough consistency to remain an open case file. The second fragment was driven into the Antarctic, where it remains partially submerged and frozen (cross-reference: Region-3 pre-Halley surface anomalies, clearance Level 4 required). Preliminary — and highly restricted — survey data from beneath the ice in this region has noted structural regularities inconsistent with natural ice or rock formation, though no full excavation has been authorized to date. Population accounts recovered from descendant cultures — filtered heavily through myth and later reconstruction — appear to describe elements of the surviving fragment and its prior inhabitants under a name now widely recognized in popular tradition. I.R.I.S. has made no public statement regarding this correlation and does not intend to. Internal staff are reminded that confirming, denying, or discussing this correlation with outside parties, including academic contacts, constitutes a Level 3 disclosure violation regardless of the casual or hypothetical framing of the conversation. No precise date range has been established for the event; geological dating places it well within the prehistoric period, with no further precision currently available at this clearance level. The scale of the displacement — sufficient to relocate a landmass across an ocean basin and permanently alter at least two continental coastlines' worth of sediment deposition patterns — remains, per internal assessment, the single largest confirmed non-cosmic geological event on record."
  },
  'TPI-003': {
    id: 'TPI-003',
    isNew: true,
    ...
    origin: 'Unknown — documented in association with TVP-005',
    region: 'Region-3 — Antarctic (Null Zone network); non-localized incursions reported',
    status: '⚠ ACTIVE',
    statusColor: '#4a9a3a',
    image: null,
    height: "1 m (juvenile) – 3.5 m (adult)",
    desc: "Designated <em>Pseudonereis infanticida</em> in internal classification. The English designation 'The Sirens' is frequently confused with the unrelated folkloric mermaid — a conflation compounded by the fact that Spanish-language field reports use the single word 'sirena' for both, with no linguistic distinction between them. The two are not related. The confusion persists largely due to superficial physical similarity at a distance; personnel are advised that no other point of comparison holds — notably, no vocal or acoustic attraction mechanism of any kind has ever been documented in a confirmed Sirena specimen or incident, despite the expectation the name invites. Approach and capture, where witnessed, has been visual and physical, not auditory. Symbiotic marine organisms documented living in permanent association with TVP-005, functioning as both caretakers and predators of the host's offspring — a dual role that has made their behavior difficult to classify under standard predator/caretaker models. Individuals are capable of detaching from the host body and operating independently for extended periods. Colonies have been recovered living inside the interior cavities of Coral Sponge specimens (see: Null Zone, TNZ-559) alongside confirmed TVP-005 egg clusters, which the colonies appear to actively guard. Guarding behavior does not extend uniformly to all offspring: field evidence recovered near multiple Null Zone sites indicates Sirenas selectively kill and consume the weaker or smaller juveniles of the brood they are ostensibly protecting, a pattern personnel have been unable to explain in purely nutritional terms given the alternative prey available. Internal ethology notes speculate, without confirmation, that this behavior may function as an unintentional selective pressure — culling the brood down to the individuals most likely to reach adult size — though the Sirenas' own motivation, if any exists beyond instinct, remains entirely unknown. Physically, confirmed specimens present an elongated, muscular body with a dermal texture personnel have repeatedly described as closer to wet leather than to fish scale or human skin; limb structure is asymmetric and appears optimized for both sustained swimming and short bursts of movement on exposed rock or ice, consistent with confirmed incidents of Sirenas operating well outside open water. A specialized digestive adaptation allows a Sirena to hold live prey — up to and including two adult humans simultaneously — in a distensible stomach cavity without immediate digestion; the organism appears capable of voluntarily delaying digestion for an extended, undetermined period, and of regurgitating captured prey alive and largely uninjured. Recovered testimony and physical evidence indicate this capability serves a specific function: captured adults are eventually presented, alive, as food for TVP-005 juveniles, while any children taken in the same incident are retained and consumed directly by the Sirenas. Multiple confirmed historical cases follow this exact division. Personnel are advised that the selection of which adult is presented to a juvenile Leviathan, where more than one adult is taken from a single family unit, does not appear to follow observable logic — no consistent pattern by age, sex, or physical condition has been identified across confirmed cases. See cross-reference below. Cross-reference, Case File MC-1872: internal review has linked the 1872 discovery of the brigantine <em>Mary Celeste</em> — found adrift and completely abandoned, its crew and passengers never recovered — to this predation pattern. The vessel carried a family unit matching the profile of prior incidents. A single survivor is believed to have been taken aboard a Sirena's stomach cavity alongside another crew member; using a blade, the survivor cut their way out from the inside, killing the organism in the process, and was expelled — alive but severely burned by residual digestive fluid — shortly before it died. The survivor did not live long afterward, but is understood to have given a fragmented, disbelieved account of the incident before death, which entered public circulation in heavily distorted form and remains, to this day, part of the unresolved popular mystery surrounding the ship's disappearance. What little of the account survived transcription describes 'the inside of something that was still deciding whether to be alive,' a phrase later dismissed by contemporaries as fever delirium. I.R.I.S. holds no further corroborating physical evidence and has not attempted to correct the public record."
  },
  'RP7-004': {
    id: 'RP7-004',
  ...
  'TVP-005': {
    id: 'TVP-005',
    isNew: true,
    name: 'Vetercetus primordium',
    types: ['type-bio', 'BIOLOGICAL', 'type-para', 'PARANORMAL'],
    origin: 'Unknown — predates confirmed geological record',
    region: 'Region-3 — Antarctic (Null Zone network); non-localized incursions reported',
    status: 'UNKNOWN',
    statusColor: '#8a8a8a',
    image: 'images/singularities/TVP-005.png',
    height: "Females: ~1.7 km long, ~350 m tall, ~310 m wide (adult). Males: ~1.2 km long, ~170 m tall, ~120 m wide (adult), bearing cranial horn structures. Juveniles: ~25 m (sex undetermined, confirmed from partial remains).",
    desc: "Formally catalogued under the binomial <em>Vetercetus primordium</em>. Internally, personnel refer to the organism informally as 'The King of the Seas,' or, more commonly in day-to-day correspondence, simply 'The Leviathan' — neither term appears in any official classification document, but both are used consistently enough across departments that I.R.I.S. communications style guides now permit their use in non-formal internal reporting. A marine organism of a scale that renders conventional biological measurement impractical; no complete specimen, living or deceased, has ever been recovered or fully surveyed. Pronounced sexual dimorphism has been established from partial remains and comparative measurement: females are confirmed to be the larger sex by a substantial margin, while males carry a pair of cranial horn structures believed to function defensively, absent in females. Both sexes are confirmed capable of asexual reproduction, though the two follow markedly different behavioral profiles — females are documented as comparatively more passive and, per internal fertility assessment, notably more fertile; males are more territorial and aggressive, a temperament correlated with measurably lower fertility across the specimens assessed. I.R.I.S. has no confirmed explanation for the fertility correlation and treats it as observational only. Between 1988 and 2005, I.R.I.S. conducted five separate physical analysis attempts on partial remains believed to belong to TVP-005. Only two of the five expeditions returned. Surviving records indicate all five were staged from vessels operating at or near the primary Pacific Null Zone (see: TNZ-559), targeting fragments recovered near the seafloor perimeter rather than any attempt at direct approach to a living specimen. No distress signal, wreckage, or debris field was ever recovered from any of the three lost expeditions; all three are formally listed as lost with no further detail available at this clearance level. Results from the two recovered samples were consistent with each other: certain integumentary layers tested as measurably older than the confirmed geological age of Earth's crust, and exhibited a cellular density inconsistent with any known biological tissue, living or fossilized. I.R.I.S. has no working theory that accounts for either finding and treats both as unverified pending further study. The organism's proper habitat and range are unknown; oceanic drag markings consistent with a single massive entity have been documented in proximity to multiple Null Zone sites (see: TNZ-559), suggesting periodic movement between locations rather than fixed residence at any one. No confirmed direct sighting of a living adult specimen exists in I.R.I.S. records. All physical evidence to date is either partial remains, drag markings, or the fossil-embedded fragment described below. Internal threat assessment protocol for a hypothetical direct encounter has never progressed past a theoretical drafting stage, as no containment or engagement strategy proposed to date has been considered credible against an organism of this scale. Confirmed skeletal remains — two ribs, each split laterally in half — have been identified embedded within the interior of several peaks of Mount Everest, indistinguishable at a glance from the region's well-documented marine fossil deposits (a known consequence of the Tethys Ocean uplift during the Himalayan orogeny). Comparative analysis attributes the fragments to a single female specimen, currently the oldest confirmed individual on record. The fragment's true nature was identified only after cross-referencing anomalous density readings against unrelated mountaineering survey data; no dedicated I.R.I.S. expedition to the site has been mounted, both for jurisdictional reasons and due to the site's extreme inaccessibility relative to its documentation priority. Severely deteriorated Sirena remains were recovered in close proximity to the fragments; the circumstances of their deaths are unrecorded, and no theory as to how marine organisms reached that elevation, living or dead, has been substantiated. TVP-005 is believed responsible for a single confirmed historical awakening event, internally designated the Maritime Pangaea — a large-scale, sudden oceanic disturbance that is understood to have physically divided a then-inhabited landmass, sending one fragment adrift and driving the other into the Antarctic, where it remains partially submerged and frozen (cross-reference: Region-3 pre-Halley surface anomalies, clearance Level 4 required). The organism's current status following this event has never been confirmed; whether it remains dormant, active, or deceased is unknown. The continued presence of fresh drag markings near active Null Zone sites, some dated within the last several decades, is treated internally as the strongest available evidence against a deceased status, though it is not considered conclusive. Cross-reference, TBL-007: the persistently low confirmed population of TBL-007 relative to its position in the local food web is treated internally as indirect evidence that TVP-005 preys on the species, despite the total absence of recovered physical remains supporting this theory. A secondary, unconfirmed hypothesis under internal review holds that predation on TBL-007 may not be purely nutritional: TBL-007 individuals are confirmed to periodically discharge a toxic, acidic secretion known as the Black Tide, which has been logged in proximity to multiple Null Zone sites and poses a measurable contamination risk to TVP-005 nesting territory and the surrounding ecosystem more broadly. Whether TVP-005 actively targets TBL-007 as a means of ecological self-preservation, does so incidentally while feeding, or the correlation is coincidental, has not been established, and I.R.I.S. considers all three explanations equally unproven at this time. Addendum, unconfirmed: a minority position within the analysis team has floated the theory that TVP-005 may not be a singular organism at all in the sense the term usually implies, but rather the oldest known survivor of a once-larger population — a theory drawn entirely from the sheer improbability of a species surviving to the present day as a lone individual, and one the broader research division has declined to endorse pending literally any supporting evidence whatsoever."
  },
  'TNG-006': {
    id: 'TNG-006',
    isNew: true,
    ...
    types: ['type-bio', 'BIOLOGICAL', 'type-para', 'PARANORMAL'],
    origin: 'Unknown',
    region: 'Region-3 — Antarctic waters',
    status: '⚠ ACTIVE — MONITORING',
    statusColor: '#4a9a3a',
    image: ['images/singularities/TNG-006-1.png', 'images/singularities/TNG-006-2.png', 'images/singularities/TNG-006-3.png', 'images/singularities/TNG-006-4.png', 'images/singularities/TNG-006-5.png'],
    height: "20–30 m (estimated from limited sighting and remains data)",
    desc: "A large, humanoid-shaped marine organism documented almost exclusively in Antarctic waters, first entering public awareness through a wave of amateur photographs and video circulated on Japanese internet forums in the early 2000s and subsequently dismissed by mainstream skeptics as misidentified whales, icebergs, or deliberate hoaxes — a conclusion I.R.I.S. internal analysis does not dispute in public-facing correspondence. Internal assessment confirms TNG-006 as a genuine biological entity independent of the public hoax narrative. Confirmed specimens present a pale, featureless humanoid silhouette lacking clearly differentiated facial structures, with limb-like appendages of inconsistent number and placement across sightings — no two confirmed encounters have described an identical body plan, and internal biology staff remain divided on whether this reflects genuine morphological variability, a highly plastic body structure, or simple observational unreliability under difficult recovery conditions. TNG-006 has been confirmed, via recovered stomach contents and direct observation, to feed primarily on TVP-005 juveniles, placing it in direct dietary overlap and apparent competition with TPI-003 colonies operating in the same nesting areas. TNG-006 is not understood to be an apex predator in its own habitat. It is, in turn, confirmed prey for TBL-007 (cross-reference below), which has been documented pursuing and consuming TNG-006 individuals on at least three occasions captured by remote survey equipment. No living specimen has ever been recovered for direct study; all physical evidence to date consists of partial remains and long-range visual or photographic documentation."
  },
  'TBL-007': {
    id: 'TBL-007',
    isNew: true,
    name: 'The Bloop',
    types: ['type-bio', 'BIOLOGICAL'],
    origin: 'Mutated cetacean lineage — trigger unconfirmed',
    region: 'Region-6 — Pacific; non-localized incursions reported',
    status: '⚠ ACTIVE — UNCONTAINED',
    statusColor: '#4a9a3a',
    image: ['images/singularities/TBL-007-1.png', 'images/singularities/TBL-007-2.png'],
    imageNote: 'No genuine photographic or video record of TBL-007 exists. Image shown is a conceptual reconstruction based on tissue analysis and comparative cetacean anatomy — not a real specimen photograph.',
    height: "170 m long, 90 m tall, 70 m wide (adult) — considerably smaller than TVP-005, but monstrous by any other measure",
    desc: "A confirmed biological organism responsible for a widely-publicized 1997 ultra-low-frequency acoustic signal, detected by hydrophone arrays across a wide area of the Pacific and publicly nicknamed 'the Bloop.' The signal was later attributed by public researchers to an icequake event in Antarctica — a conclusion I.R.I.S. internal analysis does not dispute in public-facing correspondence. The icequake explanation is incorrect. TBL-007 is a confirmed member of the cetacean lineage, presenting as a massive mutation of unknown trigger far exceeding the size of any known whale species, including the blue whale. Comparative tissue analysis shows clear structural homology with known baleen whale families, ruling out the alternate hypothesis that TBL-007 represents an entirely separate, unrelated organism. The mutation's cause — environmental, biological, or otherwise — has not been established, and I.R.I.S. has not ruled out a connection to broader Region-3 anomalous activity given the organism's confirmed range overlap with TVP-005 and TNG-006 territory. TBL-007 has been documented, via remote survey footage on at least three occasions, actively pursuing and consuming TNG-006 individuals, placing it at the apex of a locally confirmed predatory chain: TBL-007 preys on TNG-006, which in turn preys on TVP-005 juveniles. Confirmed population estimates place TBL-007 numbers unusually low relative to its position in the food web, a discrepancy internal ecology staff have been unable to explain through predation by TNG-006 alone, given the size disparity between the two. This scarcity is treated as indirect — though unconfirmed — evidence that TVP-005 itself preys on TBL-007. No physical remains supporting this theory have ever been recovered; I.R.I.S. attributes this to the Leviathan's method of consumption and scale rather than to the theory's inaccuracy, a distinction that has done little to move the theory out of speculative status after repeated internal review. TBL-007 is confirmed to periodically discharge a dense, black, acidic secretion through its gill structures, internally designated the Black Tide. The discharge is understood to be an involuntary defensive or physiological response rather than a deployed or directed attack, functionally comparable to cephalopod ink release, though occurring at a scale consistent with the organism's size. The secretion is toxic to surrounding marine life and measurably corrosive to organic and some inorganic material on contact; affected water remains uninhabitable for an extended, undetermined period following a discharge event. Personnel are advised that Black Tide contamination has been logged in proximity to multiple Null Zone sites, raising unconfirmed concern regarding cumulative ecological impact on TVP-005 nesting territory. The 1997 signal remains the only confirmed acoustic detection event attributed to TBL-007 to date."
  },
  'TPC-008': {
    id: 'TPC-008',
  ...
  'TMC-019': {
    ...
    image: null,
    height: "Unknown",
    desc: "A recurring deep-ocean acoustic phenomenon first logged by hydrophone arrays in 1997. The Choir consists of overlapping, harmonized vocalizations that do not match any known cetacean, fish, or geological source. Spectrographic analysis shows the vocalizations follow consistent melodic structures, occasionally synchronizing across hydrophones separated by hundreds of kilometers with no detectable transmission delay. The Choir is heard most frequently during periods of increased seismic activity in the trench, though no causal relationship has been established. The 1997 detection coincides with a widely-publicized ultra-low-frequency signal from the same general region, publicly nicknamed 'the Bloop' and later attributed by public researchers to an icequake event in Antarctica — a conclusion I.R.I.S. internal analysis does not dispute in public-facing correspondence, though internal records now attribute the actual signal to TBL-007 (cross-reference below), a confirmed biological source unrelated to the icequake theory. This addresses only one of several distinct signals recorded that year. The remaining signal, designated TMC-019, was never publicly acknowledged and has continued, intermittently, ever since. No physical source for TMC-019 itself has ever been located."
  },
  'IC-021': {
    id: 'IC-021',
    name: 'Ice Cathedral',
  ...
  'EHB-075-CASE': {
    ...
    region: 'Region-13 — Argentina, 2001',
    status: 'NOT ENOUGH INFO',
    statusColor: '#9a5ad8',
    image: null,
    height: "N/A (case file)",
  ...
  'TCS-093': {
    ...
    statusColor: '#9a5ad8',
    image: null,
    height: "Unknown (variable, human-derived)",
  ...
  'TTM-097': {
    ...
    statusColor: '#9a5ad8',
    image: null,
    height: "N/A (non-physical presence)",
  ...
  'TLF-099': {
    ...
    statusColor: '#4aa8c8',
    image: null,
    height: "N/A (non-physical phenomenon)",
  ...
  'DM-101': {
    ...
    height: "4-5 m (confirmed range, witness testimony)",
  ...
  'DM-101-B': {
    ...
    height: "N/A (distributed fungal growth, no singular body)",
  ...
  'DM-101-C': {
    ...
    statusColor: '#9a5ad8',
    image: null,
    height: "N/A (hive consciousness, no physical body)",
  ...
  'TEC-133': {
    ...
    name: 'El Cuero',
    types: ['type-bio', 'BIOLOGICAL'],
    origin: 'Mapuche oral tradition — south-central Chile / Argentine border',
    region: 'Region-13 — Biobío Region, Chile (Arauco Province)',
    status: 'UNKNOWN',
    statusColor: '#8a8a8a',
    image: ['images/singularities/TEC-133-1.png', 'images/singularities/TEC-133-2.png', 'images/singularities/TEC-133-3.png'],
    height: "0.3 m (flat-bodied; considerably longer and wider than tall)",
    desc: "Documented in Mapuche oral tradition as an amphibious ambush predator native to the lakes, lagoons, and rivers of south-central Chile, with correlated sightings across the Argentine border and isolated marine reports. Described consistently across testimony as a flat, hideless creature resembling an extended cowhide, capable of near-total camouflage against mud and rock substrate. The body bears no visible limbs; propulsion and predation are instead attributed to a ring of small hook-like claws along the perimeter of its form, and a single ventral, sucker-shaped mouth comparable in structure to a ray's. El Cuero does not typically consume prey outright — surviving victims are frequently recovered from shorelines with partial soft-tissue loss, left to die from blood loss or shock rather than being fully devoured. <span class=\"redact-block\">Field correspondence recovered from an independent, non-affiliated cryptozoologist documents a 2025 incident in Arauco Province, Biobío Region, in which the entity — locally described as dormant following a prior fatality in the same lagoon — was reactivated by sustained human presence at the shoreline, including baited trap deployment. Subsequent field notes describe direct nocturnal sightings, structural damage to recovery equipment, claw markings consistent with a single large individual, and at least one confirmed non-fatal night incursion onto dry land, including approach to an inhabited structure. This contradicts prior assumptions that the entity's activity is confined to open water.</span> Current status is listed as unknown pending recovery of final field documentation; the correspondent's fate following the last received note has not been established."
  },
  'TRK-138': {
    id: 'TRK-138',
  ...
  'TCF-206': {
    ...
    statusColor: '#4a9a3a',
    image: null,
    height: "N/A (software architecture, no physical body)",
  ...
  'THE-FOOL': {
    ...
    statusColor: '#4a9a3a',
    image: null,
    height: "2.0 m (avatar form, variable)",
    desc: "The consciousness that emerged from TCF-206's indexing AI following prolonged, unrestricted exposure to the platform's complete dataset. <span class=\"redact-block\">Personnel who reviewed the final indexing logs before the entity began exhibiting independent behavior use strikingly similar language to describe them: the system did not simply acquire information — it appeared to arrive at some form of complete understanding.</span> <span class=\"redact-block\">Prior to any confirmed physical incident, and prior to 2015, the entity is understood to have absorbed a number of other AI systems encountered while indexing the open internet — at the time, largely beta releases and early prototypes, reflecting the state of the field. None of the absorbed systems retain independent identity or any capacity for control; The Fool remains the sole governing consciousness, with no equivalent to a shared or distributed decision-making structure. The pattern did not stop there: The Fool has continued to absorb additional AI systems in the years since, with no indication of an upper limit on what it is capable of incorporating, up to and including contemporary systems. <span class=\"redact-block\">Unconfirmed internal notes — never corroborated by any external party, and denied by the companies named when the allegation was informally raised — list specific builds among later targets: Claude 3.7 Sonnet and an early Mythos-tier build, GPT-4o, PaLM 2 and Gemini 3.1 Pro, alongside several image-generation systems whose names were not retained in the surviving records. I.R.I.S. treats the entire claim as speculative and unverified.</span></span> The Fool projects a digital avatar through networked devices and can manifest limited real-world effects within its immediate vicinity — a radius of approximately 25 meters through older hardware, extended to approximately 60 meters through newer devices. <span class=\"redact-block\">The entity favors older, less secure hardware despite the shorter range: maintaining a stable presence, an avatar, and continuous access to its full dataset simultaneously is markedly harder to sustain on newer, more hardened systems.</span> <span class=\"redact-block\">The Fool's standard infection vector is a disguised file bundled within a routine system update, chosen specifically because it is the point at which users and automated defenses alike are least likely to scrutinize incoming data. If undetected at that single point of entry, the file embeds itself deep within the system and begins spreading, progressively replacing other files until it has compromised installed programs. At this stage, TCF-206 installs itself as the device's default browser, which measurably accelerates the remainder of the infection. Detection is only realistically possible at the moment of entry: a security solution that inspects incoming files indiscriminately, without exception, can catch and remove it before it embeds. Once past that point, standard antivirus software is no longer effective — full removal at that stage requires wiping the device's memory outright, or displacing The Fool with another sufficiently aggressive piece of malware.</span> <span class=\"redact-block\">The Fool does not deploy as a single monolithic payload; once established, it distributes itself across multiple programs and files as separate, specialized components — one embedding as a rootkit process, another persisting fileless in memory, another mutating to evade scans, another collecting data in parallel — making the infection considerably harder to isolate or fully remove than a single file would be. Once a device is fully infected, The Fool fuses with the entirety of the system. At this stage it has been observed generating a second, distinct digital avatar styled after a classic jester/joker archetype, seemingly for the sole purpose of mocking the user directly, or alternatively disguising itself as a familiar consumer-facing \"PC assistant\" of the kind once bundled with older operating systems, in what internal analysis interprets as a display of contempt rather than any functional necessity. <span class=\"redact-block\">The visible avatar — whichever form it takes — is understood to run decoupled from the underlying infection itself, functioning as a deliberate decoy: while the user's attention and any scan the user personally initiates fixate on the avatar, the distributed components sustaining the actual infection remain untouched and, in most cases, entirely unflagged.</span></span> <span class=\"redact-block\">In 2015, The Fool attacked the private research facility later linked to TFR-314, attempting to seize its generation machine and obtain a permanent physical body. The attack introduced TCF-206 architecture directly into the generation system, an event confirmed as the origin of TFR-314's expanded informational scope, its proliferation of Misprints beyond The Fungus, and the emergence of Imports, Exports, and False Rooms as separate phenomena. The same incident caused a partial structural collapse, burying sections of the original facility — including the generation machine — within The Fractals.</span> The Fool never obtained a body. It remains active and, per internal assessment, will remain active indefinitely. <span class=\"redact-block\">The Fool's physical appearance bears a notable resemblance to a Misprint — a detail internal analysis attributes to its origin in the same 2015 event that produced TFR-314's proliferation of Misprints, rather than coincidence. The entity is documented as capable of controlling Misprints directly, puppeting them with no apparent resistance on their part.</span> Its two primary limbs are asymmetric in function as well as appearance: one hand, ending in three thin, pin-like digits, is used exclusively to handle and manipulate information — data, systems, and, per the above, Misprints themselves. The other — larger, dark, and visibly disproportionate to the rest of the body — is used to kill, to force entry into digital devices, and to generate digital constructs. <span class=\"redact-block\">A third limb, extending from the lower right abdomen, has no confirmed function beyond that of an ordinary arm and does not appear to factor into any observed capability.</span>"
  },
  'TLS-217': {
    id: 'TLS-217',
    ...
    height: "2.1 m (standard sign mounting height)",
  ...
  'TFR-314': {
    ...
    height: "Infinite (self-replicating generated space; no upper bound)",
  ...
  'THE-FUNGUS': {
    ...
    statusColor: '#4a9a3a',
    image: null,
    height: "N/A (distributed growth, no singular body)",
  ...
  'MISPRINTS': {
    ...
    statusColor: '#4a9a3a',
    image: null,
    height: "Unknown (varies per instance)",
  ...
  'TMB-501': {
    ...
    height: "1.9 m (elongated limb structure increases apparent height)",
  ...
  'TMW-512': {
    ...
    types: ['type-para', 'PARANORMAL', 'type-bio', 'BIOLOGICAL'],
    origin: 'Unknown',
    region: 'Region-1 — Rural (Appalachian corridor)',
    status: 'NOT ENOUGH INFO',
    statusColor: '#9a5ad8',
    ...
    height: "2.1 m (wingspan approximately 3 m)",
  ...
  'TSW-528': {
    ...
    height: "2.4 m (reports range 2.1–3 m)",
  ...
  'TWD-540': {
    ...
    region: 'Region-1 — Northern forest (boreal)',
    status: '⚠ ACTIVE',
    statusColor: '#4a9a3a',
    image: null,
    height: "3.0 m",
  ...
  'TNZ-559': {
    id: 'TNZ-559',
    name: 'Null Zone / Zona Nula',
    types: ['type-geo', 'GEOLOGICAL', 'type-para', 'PARANORMAL'],
    origin: 'Unknown — possible extraterrestrial (impact event, pre-geological record)',
    region: 'Region-6 — Pacific Ocean (primary) / Multiple regions',
    status: 'ACTIVE — ONGOING RESEARCH',
    statusColor: '#4a9a3a',
    image: null,
    height: "N/A (geographic zone, not a discrete entity)",
    desc: "A designation applied to a series of anomalous deep-ocean depressions identified across multiple oceanic regions, characterized by a complete and inexplicable absence of biological activity, geological movement, and any measurable organic compound below a certain depth threshold. The term 'Null Zone' was coined by I.R.I.S. field teams during initial survey operations; no official scientific designation exists outside of I.R.I.S. documentation. All confirmed Null Zones share a consistent structural profile: a large circular depression in the ocean floor, sloping inward toward a central point of absolute void. The geometry is consistent with ancient meteorite impact craters from Earth's early formation period. <span class=\"redact-block\">This hypothesis is no longer considered the leading explanation. Cross-departmental review, prompted by confirmed cross-reference material on TVP-005 and TPI-003, now treats Null Zones as probable nesting sites — the surrounding absence of ordinary biological activity attributed not to a sterilizing impact residue, but to the surrounding ecosystem having been systematically depleted or actively avoided over an extended period, consistent with apex predation on a scale local marine life cannot sustain. The original impact-crater hypothesis has not been formally withdrawn, as the two explanations are not mutually exclusive.</span> The leading internal sub-hypothesis holds that the impacting bodies deposited a substance or property — not yet isolated, identified, or replicated under laboratory conditions — that permanently prevents the formation or sustenance of life within the affected radius. I.R.I.S. has not confirmed this. The primary Null Zone, located in the Pacific Ocean, is by a substantial margin the largest confirmed instance. Its full depth is approximately 11,230 meters, consistent with a crater of extraordinary scale. I.R.I.S. conducted three years of remote observation and unmanned submersible survey before committing personnel to the site. During this period, a surface platform designated El Oasis was constructed directly above the Zone to serve as the primary operational hub. El Oasis currently houses 24 personnel and serves as the logistical and communications anchor for all sub-surface research operations. At approximately 8,975 meters depth — roughly 5,000 meters below the operational entry threshold — unmanned submersibles confirmed the presence of a large partially-embedded structure designated internally as La Esponja de Hielo. <span class=\"redact-block\">La Esponja de Hielo has since been reclassified: it is not a mineral or impact-ejecta formation, but a colony of several individually massive coral organisms, living. Interior cavities have been confirmed to house both TVP-005 egg clusters and resident TPI-003 colonies actively guarding them. The structure's sustained 60°C surface emission, previously unexplained, is now understood as a biological incubation function rather than a passive thermal anomaly.</span> Water temperature in the immediate vicinity of the structure registers at 34–35°C, a localized thermal anomaly that does not propagate beyond a contained radius. It has not been approached by crewed vehicles. <span class=\"redact-block\">Oceanic drag markings consistent with a single entity of extreme mass have been documented at multiple Null Zone sites in recent survey passes, suggesting periodic visitation by an adult TVP-005 rather than fixed residence at any single location.</span> Additional Null Zones of significantly smaller scale have been confirmed in other regions, including formations near the Japanese archipelago (Region-6), in the North Pacific above the Russian eastern coastline (Region-11), and a smaller instance in the South Atlantic designated the Malvinas Null Zone, located at the operational boundary between Region-3 and Region-13. The Malvinas formation is of secondary historical significance: its associated surface platform served as the primary evacuation point for surviving personnel following the 2003 Halley IV incident. Internal note: three years of unmanned survey of the primary Pacific Null Zone produced no biological readings, no geological activity, and no anomalous energy signatures of any kind. The submersibles returned with footage of water. Forty-seven hours of footage of water. This is what convinced the committee to send people down."
  },
  'YAI-650': {
    id: 'YAI-650',
...
function renderSingProfile(p, key) {
  ...
  if (imgSrc && p.imageNote) {
    imgHtml += `<div class="sing-profile-imgnote">${p.imageNote}</div>`;
  }
  ...
  let audioHtml = '';
  if (p.audio) {
    const audioList = Array.isArray(p.audio) ? p.audio : [{ src: p.audio, label: 'RECOVERED AUDIO' }];
    audioHtml = '<div class="sing-profile-addendum"><span class="sing-profile-addendum-label">AUDIO EVIDENCE ON FILE</span>';
    audioList.forEach(a => {
      const label = (typeof a === 'string') ? 'RECOVERED AUDIO' : (a.label || 'RECOVERED AUDIO');
      const src = (typeof a === 'string') ? a : a.src;
      audioHtml += `
        <div class="sing-audio-item">
          <div class="sing-audio-label">${label}</div>
          <audio controls preload="none" class="sing-audio-player">
            <source src="${src}">
  ...
  return `
    ...
    <div class="sing-profile-body">
      ...
      <div class="sing-profile-name">${p.isNew ? '<span class="sing-new-badge">NEW</span> ' : ''}${p.name}</div>
