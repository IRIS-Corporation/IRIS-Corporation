...
const singularityProfiles = {
  ...
  'TPM-002': {
    ...
    desc: "Internal designation for a confirmed prehistoric large-scale oceanic disturbance, understood to be the direct result of a single awakening event attributed to TVP-005. The event is classified as Geological rather than Biological or Paranormal, as its documented effects — sudden, sustained reordering of global ocean currents and sea levels sufficient to physically displace a landmass — are consistent with catastrophic geological upheaval rather than any discrete biological action. <span class=\"redact-block\">The Maritime Pangaea is confirmed to have physically divided a then-inhabited landmass. One fragment was driven adrift and is believed to survive, unlocated, somewhere in the world's oceans. The second fragment was driven into the Antarctic, where it remains partially submerged and frozen (cross-reference: Region-3 pre-Halley surface anomalies, clearance Level 4 required). Population accounts recovered from descendant cultures — filtered heavily through myth and later reconstruction — appear to describe elements of the surviving fragment and its prior inhabitants under a name now widely recognized in popular tradition. I.R.I.S. has made no public statement regarding this correlation and does not intend to.</span> No precise date range has been established for the event; geological dating places it well within the prehistoric period, with no further precision currently available at this clearance level."
  },
  'TPI-003': {
    id: 'TPI-003',
    isNew: true,
  ...
  'TVP-005': {
    ...
    statusColor: '#8a8a8a',
    image: null,
    height: "~1.7 km (adult, estimated — never directly measured in full); ~25 m (juveniles, confirmed from partial remains)",
    desc: "Designated <em>Vetercetus primordium</em> in internal classification. A marine organism of a scale that renders conventional biological measurement impractical; no complete specimen, living or deceased, has ever been recovered or fully surveyed. <span class=\"redact-block\">Between 1988 and 2005, I.R.I.S. conducted five separate physical analysis attempts on partial remains believed to belong to TVP-005. Only two of the five expeditions returned. Results from the recovered samples were consistent across both: certain integumentary layers tested as measurably older than the confirmed geological age of Earth's crust. I.R.I.S. has no working theory that accounts for this finding and treats it as unverified pending further study.</span> The organism's proper habitat and range are unknown; oceanic drag markings consistent with a single massive entity have been documented in proximity to multiple Null Zone sites (see: TNZ-559), suggesting periodic movement between locations rather than fixed residence at any one. <span class=\"redact-block\">A single confirmed skeletal fragment — believed to represent one or two ribs from a full adult specimen — has been identified as structurally embedded in the base formation of several peaks of Mount Everest, indistinguishable at a glance from the region's well-documented marine fossil deposits (a known consequence of the Tethys Ocean uplift during the Himalayan orogeny). Severely deteriorated Sirena remains were recovered in close proximity to the fragment; the circumstances of their deaths are unrecorded.</span> <span class=\"redact-block\">TVP-005 is believed responsible for a single confirmed historical awakening event, internally designated the Maritime Pangaea — a large-scale, sudden oceanic disturbance that is understood to have physically divided a then-inhabited landmass, sending one fragment adrift and driving the other into the Antarctic, where it remains partially submerged and frozen (cross-reference: Region-3 pre-Halley surface anomalies, clearance Level 4 required). The organism's current status following this event has never been confirmed; whether it remains dormant, active, or deceased is unknown.</span>"
  },
  'TPC-008': {
    id: 'TPC-008',
